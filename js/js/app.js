...
const CapturePage = {
  ...
  // فقط عدد مبلغ کل رو آپدیت می‌کنیم، بدون بازسازی کل جدول
  // (بازسازی کامل باعث می‌شد فوکوس و کیبورد قطع بشه)
    ...
    this.rows.forEach((row, i) => {
      ...
      div.innerHTML = `
        ...
        <div class="item-row-fields">
          ...
          <div>
            <label>مبلغ کل</label>
            <input type="number" inputmode="decimal" value="${row.totalPrice}" data-field="totalPrice" data-index="${i}" readonly />
          </div>
        </div>`;
